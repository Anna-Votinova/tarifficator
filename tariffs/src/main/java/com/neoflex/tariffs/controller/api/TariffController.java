...
public class TariffController {
    ...
    public TariffDto updateTariff(
        ...
        return tariffService.updateTariff(accessToken, tariffId, tariffUpdateDto);
    }
    ...
    public void removeTariff(@RequestHeader("Authorization") String accessToken,
        ...
        tariffService.removeTariff(accessToken, tariffId);
    ...
    public void installTariff(@RequestHeader("Authorization") String accessToken,
        ...
        tariffService.installTariff(accessToken, productId, tariffId);
    }
    ...
    public TariffDto getTariff(@RequestHeader("Authorization") String accessToken,
        ...
        return tariffService.getTariff(accessToken, tariffId);
    }
    ...
    public List<TariffDto> getAll(
        ...
        return tariffService.getAll(accessToken, searchPhrase, fromPage, toPage);
    }
}
