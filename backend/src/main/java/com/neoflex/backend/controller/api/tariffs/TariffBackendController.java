...
public class TariffBackendController {
    ...
    public TariffDto createTariff(@Valid @RequestBody TariffCreateDto tariffCreateDto) {
        ...
        return tariffClient.createTariff(tariffCreateDto);
    }
    ...
    public TariffDto updateTariff(
        ...
        return tariffClient.updateTariff(tariffId, tariffUpdateDto);
    }
    ...
    public void removeTariff(@PathVariable @Parameter(description = "Идентификатор тарифа",
        ...
        tariffClient.removeTariff(tariffId);
    ...
    public void installTariff(@PathVariable @Parameter(description = "Идентификатор продукта",
        ...
        tariffClient.installTariff(productId, tariffId);
    }
    ...
    public List<TariffDto> getAll(
        ...
        return tariffClient.getAll(searchPhrase, fromPage, toPage);
    }
}
